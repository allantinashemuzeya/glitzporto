const CACHE_VERSION = '1.7.70';

const BASE_CACHE_FILES = [
    'https://glitz.ddev.site/wp-content/plugins/pwa-for-wp/images/logo.png',
'https://glitz.ddev.site/wp-content/plugins/pwa-for-wp/images/logo-512x512.png',
'https://glitz.ddev.site/wp-content/plugins/pwa-for-wp/images/logo-512x512.png',

];

const OFFLINE_CACHE_FILES = [
     'https://glitz.ddev.site/',
];
...
const OFFLINE_PAGE = 'https://glitz.ddev.site/';
const NOT_FOUND_PAGE = 'https://glitz.ddev.site/';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://glitz.ddev.site//wp-admin/');
//    },
];
